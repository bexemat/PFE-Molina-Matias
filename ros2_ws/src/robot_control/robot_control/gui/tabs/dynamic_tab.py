...
class DynamicTab(QWidget):
    """Pestaña dedicada a la Interfaz Dinámica Síncrona (Medición + Intercepción a +120mm)."""
    ...
    def setup_ui(self):
        ...
        self.lbl_camera_dyn = QLabel("Esperando flujo dinámico...")
        ...
        # Botón 1: Setear / Medir Velocidad
        self.btn_dyn_set_vel = QPushButton("1️⃣ Setear / Calcular Velocidad (300 mm)")
        self.btn_dyn_set_vel.setFont(QFont("Arial", 11, QFont.Bold))
        self.btn_dyn_set_vel.setStyleSheet("background-color: #d35400; color: white; padding: 10px; border-radius: 5px;")

        # Visualizador de Velocidad Guardada
        ...
        # Botón 2: Interceptar en Y = +120 mm
        self.btn_dyn_exec = QPushButton("2️⃣ Calcular Tiempo e Interceptar (+120 mm)")
        self.btn_dyn_exec.setFont(QFont("Arial", 11, QFont.Bold))
        self.btn_dyn_exec.setStyleSheet("background-color: #2980b9; color: white; padding: 10px; border-radius: 5px;")
        
        self.lbl_dyn_status = QLabel("Estado: Esperando setear velocidad...")
