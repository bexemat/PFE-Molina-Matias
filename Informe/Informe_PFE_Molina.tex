...
\begin{itemize}
    \item \textbf{Compuerta de Entrada ($Y_1 = -140.0\text{ mm}$):} Registra la marca temporal de cruce $t_1$ mediante \texttt{time.perf\_counter()} junto a la coordenada observada $y_1$.
    \item \textbf{Compuerta de Medición y Disparo ($Y_2 = -70.0\text{ mm}$):} Registra la marca temporal $t_2$ y la posición $y_2$ al completar el recorrido nominal fijo $\Delta Y = 70.0\text{ mm}$.
\end{itemize}
