...
Se dispuso el objeto en coordenadas cartesianas alternadas conocidas dentro del espacio de trabajo sobre la cinta detenida ($X = 220\text{ mm}$, $Z = 78\text{ mm}$, $Y \in [+10, +140]\text{ mm}$). Se realizaron 30 repeticiones evaluando el error posicional euclídeo de agarre y el tiempo total de ciclo.
...
\hline
\textbf{Nº} & \textbf{$Y_{\text{pick}}$ [mm]} & \textbf{Pick} & \textbf{Place} & \textbf{Clasificación} \\ \hline
1  & 39    & $\checkmark$ & $\checkmark$ & Cubo \\ \hline
2  & 12,9  & $\checkmark$ & $\checkmark$ & Cono \\ \hline
3  & 92,2  & $\checkmark$ & $\checkmark$ & Cono \\ \hline
4  & 80    & $\checkmark$ & $\checkmark$ & Cubo \\ \hline
5  & 140   & $\checkmark$ & $\checkmark$ & Cubo \\ \hline
...
10 & 73    & $\checkmark$ & $\checkmark$ & Cubo \\ \hline
11 & 31    & $\checkmark$ & $\checkmark$ & Cono \\ \hline
12 & 113   & $\checkmark$ & $\checkmark$ & Cono \\ \hline
...
17 & 144   & $\checkmark$ & $\checkmark$ & Cono \\ \hline
18 & 10    & $\checkmark$ & $\checkmark$ & Cubo \\ \hline
...
\hline
\textbf{Nº} & \textbf{V [mm/s]} & \textbf{Pick} & \textbf{Place} & \textbf{Clasificación} & \textbf{Observaciones / Diagnóstico} \\ \hline
